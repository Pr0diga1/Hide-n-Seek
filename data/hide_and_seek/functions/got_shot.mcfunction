#setcolor when shot
execute if score count seekers matches ..2 run scoreboard players set @s color -6
execute if score count seekers matches 3.. run scoreboard players set @s color -14
#set tag when shot
tag @s remove hider
